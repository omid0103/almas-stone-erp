...
export default function Invoices(){
 ...
 const [customerId,setCustomerId]=useState(''),[jalali,setJalali]=useState(''),[discount,setDiscount]=useState(0),[freight,setFreight]=useState(0),[notes,setNotes]=useState('');
 ...
 useEffect(()=>{load()},[]);
 function reset(){setCustomerId('');setJalali('');setDiscount(0);setFreight(0);setNotes('');setLines([{...emptyLine}]);setMsg('')}
